...
export type Mutation = {
   __typename?: 'Mutation',
  signUpUser?: Maybe<UserStep1>,
  selectUserPlanAndFinishSignUp?: Maybe<Scalars['String']>,
...
export type MutationSelectUserPlanAndFinishSignUpArgs = {
  id: Scalars['ObjectID'],
...
export type SubscriptionSubmissionActiveArgs = {
...
export type ResolversTypes = {
  ...
  UserIn: UserIn,
  UserStep1: ResolverTypeWrapper<UserStep1>,
...
export type AuthRequiredDirectiveResolver<Result, Parent, ContextType = any, Args = {   requires?: Maybe<Maybe<Array<Maybe<Role>>>> }> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type CloudResourcesResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['CloudResourcesResult'] = ResolversParentTypes['CloudResourcesResult']> = {
  resources?: Resolver<Maybe<Array<Maybe<ResolversTypes['Resource']>>>, ParentType, ContextType>,
  pagesNumber?: Resolver<Maybe<ResolversTypes['Number']>, ParentType, ContextType>,
};
...
export type DocImageResolvers<ContextType = any, ParentType extends ResolversParentTypes['DocImage'] = ResolversParentTypes['DocImage']> = {
  image?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  isSnapshot?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
};

export type DocsAndFoldersResolvers<ContextType = any, ParentType extends ResolversParentTypes['DocsAndFolders'] = ResolversParentTypes['DocsAndFolders']> = {
...
export type DocumentResolvers<ContextType = any, ParentType extends ResolversParentTypes['Document'] = ResolversParentTypes['Document']> = {
  ...
  advancedMode?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type ExerciseResolvers<ContextType = any, ParentType extends ResolversParentTypes['Exercise'] = ResolversParentTypes['Exercise']> = {
  id?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  document?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  user?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  ...
  type?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  teacherName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  acceptSubmissions?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
  image?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
...
export type FileResolvers<ContextType = any, ParentType extends ResolversParentTypes['File'] = ResolversParentTypes['File']> = {
  ...
  storageName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
};
...
export type FolderResolvers<ContextType = any, ParentType extends ResolversParentTypes['Folder'] = ResolversParentTypes['Folder']> = {
  ...
  user?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  documentsID?: Resolver<Maybe<Array<Maybe<ResolversTypes['ObjectID']>>>, ParentType, ContextType>,
  foldersID?: Resolver<Maybe<Array<Maybe<ResolversTypes['ObjectID']>>>, ParentType, ContextType>,
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  signUpUser?: Resolver<Maybe<ResolversTypes['UserStep1']>, ParentType, ContextType, RequireFields<MutationSignUpUserArgs, 'input'>>,
  selectUserPlanAndFinishSignUp?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<MutationSelectUserPlanAndFinishSignUpArgs, 'id' | 'userPlan'>>,
  activateAccount?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, MutationActivateAccountArgs>,
  login?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<MutationLoginArgs, 'email' | 'password'>>,
  renewToken?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  resetPasswordEmail?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<MutationResetPasswordEmailArgs, 'email'>>,
  checkResetPasswordToken?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, MutationCheckResetPasswordTokenArgs>,
  updatePassword?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, MutationUpdatePasswordArgs>,
  ...
  setDocumentImage?: Resolver<Maybe<ResolversTypes['Document']>, ParentType, ContextType, MutationSetDocumentImageArgs>,
  updateDocumentContent?: Resolver<Maybe<ResolversTypes['Document']>, ParentType, ContextType, MutationUpdateDocumentContentArgs>,
  publishDocument?: Resolver<Maybe<ResolversTypes['Document']>, ParentType, ContextType, RequireFields<MutationPublishDocumentArgs, 'id'>>,
  createExercise?: Resolver<Maybe<ResolversTypes['Exercise']>, ParentType, ContextType, RequireFields<MutationCreateExerciseArgs, 'input'>>,
  changeSubmissionsState?: Resolver<Maybe<ResolversTypes['Exercise']>, ParentType, ContextType, RequireFields<MutationChangeSubmissionsStateArgs, 'id' | 'subState'>>,
  updateExercise?: Resolver<Maybe<ResolversTypes['Exercise']>, ParentType, ContextType, RequireFields<MutationUpdateExerciseArgs, 'id'>>,
  deleteExercise?: Resolver<Maybe<ResolversTypes['Exercise']>, ParentType, ContextType, RequireFields<MutationDeleteExerciseArgs, 'id'>>,
  createFolder?: Resolver<Maybe<ResolversTypes['Folder']>, ParentType, ContextType, MutationCreateFolderArgs>,
  updateFolder?: Resolver<Maybe<ResolversTypes['Folder']>, ParentType, ContextType, RequireFields<MutationUpdateFolderArgs, 'id'>>,
  deleteFolder?: Resolver<Maybe<ResolversTypes['Folder']>, ParentType, ContextType, RequireFields<MutationDeleteFolderArgs, 'id'>>,
  startSubmission?: Resolver<Maybe<ResolversTypes['loginOut']>, ParentType, ContextType, RequireFields<MutationStartSubmissionArgs, 'exerciseCode' | 'studentNick' | 'password'>>,
  loginSubmission?: Resolver<Maybe<ResolversTypes['loginOut']>, ParentType, ContextType, RequireFields<MutationLoginSubmissionArgs, 'exerciseCode' | 'studentNick' | 'password'>>,
  updateSubmission?: Resolver<Maybe<ResolversTypes['Submission']>, ParentType, ContextType, MutationUpdateSubmissionArgs>,
  finishSubmission?: Resolver<Maybe<ResolversTypes['Submission']>, ParentType, ContextType, MutationFinishSubmissionArgs>,
  cancelSubmission?: Resolver<Maybe<ResolversTypes['Submission']>, ParentType, ContextType>,
  deleteSubmission?: Resolver<Maybe<ResolversTypes['Submission']>, ParentType, ContextType, RequireFields<MutationDeleteSubmissionArgs, 'submissionID'>>,
  gradeSubmission?: Resolver<Maybe<ResolversTypes['Submission']>, ParentType, ContextType, MutationGradeSubmissionArgs>,
  updatePasswordSubmission?: Resolver<Maybe<ResolversTypes['Submission']>, ParentType, ContextType, RequireFields<MutationUpdatePasswordSubmissionArgs, 'submissionID' | 'password'>>,
  setActiveSubmission?: Resolver<Maybe<ResolversTypes['Submission']>, ParentType, ContextType, RequireFields<MutationSetActiveSubmissionArgs, 'submissionID' | 'active'>>,
  singleUpload?: Resolver<Maybe<ResolversTypes['File']>, ParentType, ContextType, RequireFields<MutationSingleUploadArgs, 'file'>>,
  uploadSTLFile?: Resolver<Maybe<ResolversTypes['File']>, ParentType, ContextType, RequireFields<MutationUploadStlFileArgs, 'file'>>,
  uploadImageFile?: Resolver<Maybe<ResolversTypes['File']>, ParentType, ContextType, RequireFields<MutationUploadImageFileArgs, 'file'>>,
  deleteUserFile?: Resolver<Maybe<ResolversTypes['File']>, ParentType, ContextType, RequireFields<MutationDeleteUserFileArgs, 'filename'>>,
  moveToTrash?: Resolver<Maybe<ResolversTypes['File']>, ParentType, ContextType, MutationMoveToTrashArgs>,
  restoreResource?: Resolver<Maybe<ResolversTypes['File']>, ParentType, ContextType, MutationRestoreResourceArgs>,
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  documentsAndFolders?: Resolver<Maybe<ResolversTypes['DocsAndFolders']>, ParentType, ContextType, QueryDocumentsAndFoldersArgs>,
  hasExercises?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<QueryHasExercisesArgs, 'id'>>,
  openPublicDocument?: Resolver<Maybe<ResolversTypes['Document']>, ParentType, ContextType, RequireFields<QueryOpenPublicDocumentArgs, 'id'>>,
  examples?: Resolver<Maybe<Array<Maybe<ResolversTypes['Document']>>>, ParentType, ContextType>,
  exercises?: Resolver<Maybe<Array<Maybe<ResolversTypes['Exercise']>>>, ParentType, ContextType>,
  exercise?: Resolver<Maybe<ResolversTypes['Exercise']>, ParentType, ContextType, RequireFields<QueryExerciseArgs, 'id'>>,
  exercisesByDocument?: Resolver<Maybe<Array<Maybe<ResolversTypes['Exercise']>>>, ParentType, ContextType, RequireFields<QueryExercisesByDocumentArgs, 'document'>>,
  exerciseByCode?: Resolver<Maybe<ResolversTypes['Exercise']>, ParentType, ContextType, RequireFields<QueryExerciseByCodeArgs, 'code'>>,
  folders?: Resolver<Maybe<Array<Maybe<ResolversTypes['Folder']>>>, ParentType, ContextType>,
  folder?: Resolver<Maybe<ResolversTypes['Folder']>, ParentType, ContextType, RequireFields<QueryFolderArgs, 'id'>>,
  rootFolder?: Resolver<Maybe<ResolversTypes['Folder']>, ParentType, ContextType>,
  submissions?: Resolver<Maybe<Array<Maybe<ResolversTypes['Submission']>>>, ParentType, ContextType>,
  submission?: Resolver<Maybe<ResolversTypes['Submission']>, ParentType, ContextType, QuerySubmissionArgs>,
  submissionsByExercise?: Resolver<Maybe<Array<Maybe<ResolversTypes['Submission']>>>, ParentType, ContextType, RequireFields<QuerySubmissionsByExerciseArgs, 'exercise'>>,
  uploads?: Resolver<Maybe<Array<Maybe<ResolversTypes['File']>>>, ParentType, ContextType>,
  getUserFiles?: Resolver<Maybe<Array<Maybe<ResolversTypes['File']>>>, ParentType, ContextType>,
  cloudResources?: Resolver<Maybe<ResolversTypes['CloudResourcesResult']>, ParentType, ContextType, QueryCloudResourcesArgs>,
};
...
export type SubmissionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Submission'] = ResolversParentTypes['Submission']> = {
  id?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  exercise?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  user?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  document?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  studentNick?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  password?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  content?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  cache?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  submissionToken?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  finished?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
  studentComment?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  type?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  createdAt?: Resolver<Maybe<ResolversTypes['Date']>, ParentType, ContextType>,
  updatedAt?: Resolver<Maybe<ResolversTypes['Date']>, ParentType, ContextType>,
...
export type SubscriptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = {
  documentUpdated?: SubscriptionResolver<Maybe<ResolversTypes['Document']>, "documentUpdated", ParentType, ContextType>,
  folderUpdated?: SubscriptionResolver<Maybe<ResolversTypes['Folder']>, "folderUpdated", ParentType, ContextType>,
  submissionUpdated?: SubscriptionResolver<Maybe<ResolversTypes['Submission']>, "submissionUpdated", ParentType, ContextType, RequireFields<SubscriptionSubmissionUpdatedArgs, 'exercise'>>,
  submissionActive?: SubscriptionResolver<Maybe<ResolversTypes['Submission']>, "submissionActive", ParentType, ContextType, RequireFields<SubscriptionSubmissionActiveArgs, 'token'>>,
};
...
export type UserResolvers<ContextType = any, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
  ...
  teacherPro?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
  family?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
  name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  surnames?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  bornDate?: Resolver<Maybe<ResolversTypes['Date']>, ParentType, ContextType>,
  center?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  active?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
  signUpToken?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  ...
  imTeacherCheck?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
  centerName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  educationalStage?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  province?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  postCode?: Resolver<Maybe<ResolversTypes['Number']>, ParentType, ContextType>,
...
export type UserStep1Resolvers<ContextType = any, ParentType extends ResolversParentTypes['UserStep1'] = ResolversParentTypes['UserStep1']> = {
  id?: Resolver<Maybe<ResolversTypes['ObjectID']>, ParentType, ContextType>,
  email?: Resolver<Maybe<ResolversTypes['EmailAddress']>, ParentType, ContextType>,
};
...
export type Resolvers<ContextType = any> = {
  ...
  UserStep1?: UserStep1Resolvers<ContextType>,
};
